...
export default function TrainingProfile() {
  ...
  return (
    <section className="flex flex-col gap-4">
      <header>
        <h1 className="text-xl font-bold">Training profile</h1>
        <p className="mt-1 text-sm text-ink-secondary">
          Used to filter and adjust your exercise suggestions.
        </p>
      </header>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <Button type="submit" size="lg" block loading={saving} variant={saved ? "secondary" : "primary"}>
          {saving ? "Saving..." : saved ? "Saved" : "Save training profile"}
        </Button>
      </form>
